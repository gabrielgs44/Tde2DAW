			...
			<fieldset>
				...
				<p>
					<label for="cliente">Cliente: </label> <input type="text"
						id="cliente" name="cliente" value="<%=festa.getCliente()%>">
				</p>
				<p>
					<label for="aniversariante">Aniversariante: </label> <input
						type="text" id="aniversariante" name="aniversariante"
						value="<%=festa.getAniversariante()%>">
				</p>
				<p>
				...
				<p style="background-color: red;">
					<font color="white"><b>A hora de término não pode ser
							menor que a hora de início!!</b></font>
				</p>
				<%
				    }
				%>
